...
@Slf4j
@Component
public class TaskInstanceDispatchOperationFunctionWorker
        implements
        ITaskInstanceOperationFunctionWorker<TaskInstanceDispatchRequest, TaskInstanceDispatchResponse> {
    ...
    public TaskInstanceDispatchOperationFunctionWorker(

...
@Slf4j
@Component
public class UpdateWorkflowHostOperationFunctionWorker
        implements
        ITaskInstanceOperationFunctionWorker<UpdateWorkflowHostRequest, UpdateWorkflowHostResponse> {

    @Autowired
    private MessageRetryRunner messageRetryRunner;

    public UpdateWorkflowHostOperationFunctionWorker(MessageRetryRunner messageRetryRunner) {

...
@Slf4j
@Component
public class TaskInstanceKillOperationFunctionWorker
        implements
        ITaskInstanceOperationFunctionWorker<TaskInstanceKillRequest, TaskInstanceKillResponse> {
    ...
    public TaskInstanceKillOperationFunctionWorker(

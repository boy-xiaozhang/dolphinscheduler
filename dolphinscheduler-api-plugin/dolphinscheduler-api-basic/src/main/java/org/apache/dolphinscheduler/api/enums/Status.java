...
public enum Status {
    ...
    DATA_DOMAIN_QUERY_ERROR(150001, "query data domain error", "查询数据域错误"),
    DATA_DOMAIN_DELETE_ERROR(150002, "delete data domain by ids error", "删除数据域错误,请检查参数"),
    DATA_DOMAIN_DELETE_ZERO_ERROR(150003, "delete data domain by ids error", "数据仅删除0条,请检查是否选中需要删除的数据域"),

    DATA_DOMAIN_CREATE_ERROR(150004, "create data domain error", "创建数据域错误,请检查"),

    DATA_DOMAIN_UPDATE_ERROR(150004, "create data domain error", "修改数据域错误,请检查参数"),

    DATA_DOMAIN_ID_NULL_ERROR(150005, "data domain id is null error", "数据域ID为空,请联系开发人员检查"),

    DATA_DOMAIN_NOT_FOUND_ERROR(150006, "data domain not found error", "数据域未找到,请刷新页面"),

    DATA_SERVER_DIR_NOT_FOUND_ERROR(160001, "A directory is a must", "必须有文件夹目录,请联系管理员检查"),
